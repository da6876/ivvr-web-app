                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-2 mb-md-0 text-uppercase fw-medium">Item Setup > Measure Unit</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addRoleForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="row g-1">
                            <div class="col mb-1">
                                <label class="form-label" for="msr_unit_code">Code</label>
                                <input type="text" id="msr_unit_code" name="msr_unit_code" class="form-control" placeholder="Enter Aux Type" tabindex="-1"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="row g-1">
                            <div class="col mb-1">
                                <label class="form-label" for="msr_unit_desc">Descr</label>
                                <input type="text" id="msr_unit_desc" name="msr_unit_desc" class="form-control" placeholder="Enter Aux Type Descr"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        function showModal() {
            ...
            $(".modal-title").text("Add Measure Unit");
            $("#addModal").modal("show");
            $('#id').val('');
        }
        ...
        function showData(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#addModal').modal('show');
                    $('#id').val(data.id);
                    $('#msr_unit_code').val(data.msr_unit_code);
                    $('#msr_unit_desc').val(data.msr_unit_desc);
