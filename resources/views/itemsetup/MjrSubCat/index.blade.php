@section('title',"Sub-Major Category")
@extends('layout.app')
@section('main')
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-2 mb-md-0 text-uppercase fw-medium">Item Setup > Sub-Major Category</h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 ml-1">
                                            <div class="form-group">
                                                <select class="form-select select2" name="SelectMajor" id="SelectMajor">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="email" name="email"
                                                       class="form-control form-control-sm"
                                                       placeholder="Enter Mjr Sub Desc For Search" aria-label="Username">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="modal-body">
                    <form id="addRoleForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="col-12 mb-3">
                            <label class="form-label" for="mjr_sub_code">Code</label>
                            <input type="text" id="mjr_sub_code" name="mjr_sub_code" class="form-control" placeholder="Enter Code" tabindex="-1"/>
                            <div class="invalid-feedback"></div>
                        </div>

                        <!-- Desc Field -->
                        <div class="col-12 mb-3">
                            <label class="form-label" for="mjr_sub_desc">Desc</label>
                            <input type="text" id="mjr_sub_desc" name="mjr_sub_desc" class="form-control" placeholder="Enter Desc"/>
                            <div class="invalid-feedback"></div>
                        </div>

                        <!-- Major and Status Select Fields -->
                        <div class="row g-3">
                            <!-- Select Major -->
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="mjr_code">Select Major</label>
                                <select class="form-select select2" name="mjr_code" id="mjr_code">
                                    <option value="">Select Major</option>
...
@section('script')
    ...
    <script>
        ...
        function showModal() {
            ...
            $(".modal-title").text("Add Sub Major Category");
            $("#addModal").modal("show");
            $('#id').val('');
            getMajor('');
        }
        ...
        $(document).ready(function () {
            ...
            var table = $('#usersTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('mjrSubCat.data') }}',
                    type: 'POST',
                    data: function (d) {
                        d._token = $('input[name="_token"]').val(); // Include CSRF token
                        d.SelectMajor = $('#SelectMajor').val();
        ...
        function showData(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#addModal').modal('show');
                    $('#id').val(data.id);
                    $('#mjr_sub_code').val(data.mjr_sub_code);
                    $('#mjr_sub_desc').val(data.mjr_sub_desc);
                    getMajor('',data.mjr_code);
        ...
        function getMajor(type,id=null) {
            ...
            var surl = "{{ url('getMajor') }}";
            $.ajax({
                url: surl,
                type: 'GET',
                data: {'ViewType': 'Division', "_token": csrf_tokens},
                datatype: 'JSON',
                success: function (category) {
                    ...
                    if (category != '') {
                        ...
                        if (type=='Search'){
                            $("#SelectMajor").html(markup).show();
                        }else{
                            $("#mjr_code").html(markup).show();
                        }
                        $('#SelectMajor').val(id);
                    } else {
                        if (type=='Search'){
